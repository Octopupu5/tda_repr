...
class RepresentationMonitor:
	...
	- attaches forward hooks to chosen layers
	...
	def _get_graph_rows(self, X: np.ndarray, stage: str, layer: str) -> Tuple[np.ndarray, Dict[str, Any]]:
		"""
		Return a downsampled point cloud for graph computations.
		If fixed_graph_points=True, reuse the same row indices across epochs.
		"""
