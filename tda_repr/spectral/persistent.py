...
def eigs_persistent_up(
	...
	"""
	Compute k eigenvalues of up-persistent Laplacian.
	Default is largest magnitude; pass which='SM' or 'SA' for smallest.
	"""
...
def persistent_down_laplacian_operator(
	...
	"""
	Build a LinearOperator for the down part of the persistent Laplacian.
	"""
	_ = (L, regularization, use_ridge)
...
def eigs_persistent(
	...
	"""
	Compute k eigenvalues of the full persistent Laplacian.
	"""
